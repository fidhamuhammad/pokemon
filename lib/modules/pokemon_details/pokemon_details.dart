...
import 'package:app/modules/pokemon_grid/wishlist/bloc/wishlist_event.dart';
      ...
      listener: (BuildContext context, WishlistState state) { 
          if (state is PokemonError) {
             ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content: Text(state.message,style: TextStyle(color: Colors.blue),),
                        ),
                      );
          }
                    ...
                    return AppBar(
                      title: AnimatedOpacity(
                          ...
                          child: Visibility(
                            ...
                            visible:
                                _pokemonDetailsStore.opacityTitleAppbar > 0,
                          )),
                      ...
                      actions: [
                        if (_pokemonStore
                          ...
                          IconButton(
                            ...
                            onPressed: () {
                              final String email =
                              context.read<AuthStatusProvider>().email;

                              context.read<WishlistBloc>().add(
                                  AddFavouriteEvent(
                                      name: _pokemonStore.pokemon!.name,
                                      email: email));
